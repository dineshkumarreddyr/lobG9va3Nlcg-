...
class Usermodel extends CI_Model {
    ...
    {
        $data = array();
        $query = $this->db->query("SELECT u.user_id, u.user_fname, u.user_lname, ud.user_image, count(l.l_id) as l_count FROM users u, user_details ud, looks l WHERE u.user_id = l.l_uid AND u.user_id = ud.ud_uid AND l.l_status = '1' AND u.user_status = '1' AND u.user_role = 2");
        $data = $query->result();
        return $data;        
    }
