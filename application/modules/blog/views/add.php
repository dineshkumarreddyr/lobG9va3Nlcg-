...
<div class="container blog-edit-wrap">
  <div class="row">
    ...
    <div class="form-group">
      ...
      <textarea name="content" id="content" class="form-controll"></textarea>
    </div>
    ...
    <div class="form-group">
      <label for="caption">Courtesy <span>The source destination of the image selected</span></label>
      <input type="text" name="courtesy" id="courtesy" class="form-controll">
    </div>

    <div class="form-group">
      <!--<input type="button" class="buttons" value="Upload image">-->
      <input type="submit" name="submit" id="submit" class="savearticle" value="Save Article">
    </div>
  </form>
  </div>
  </div>
